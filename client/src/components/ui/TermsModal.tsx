      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90dvh]">
        ...
        >
          <section>
            ...
            <p>
              EvLY est une application de planification sociale permettant à des groupes d'amis et de proches
          ...
          <section>
            ...
            <p>
              Pour utiliser EvLY, tu dois créer un compte avec un pseudo et un mot de passe.
          ...
          <section>
            ...
            <p>
              EvLY collecte uniquement les données nécessaires au fonctionnement du service :
          ...
          <section>
            ...
            <p>
              EvLY est fourni « en l'état », sans garantie de disponibilité continue.
